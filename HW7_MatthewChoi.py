...
def litCricFriend(wordList, text):
    ...
    newWordList = []
    for i in splitText:
        newWordList += i.strip(string.punctuation)
    ...
    for word in wordList:
        countText += newWordList.count(word)
    ...
    lengthOfList=len(newWordList)
    ratio = countText / lengthOfList
    return(ratio)
...
print('bellsFreq',litCricFriend(['a','an'],theBells))
print('cantoFreq',litCricFriend(['a','an'],cantoXII))
print('bellsThe',litCricFriend('the',theBells))
print('cantoThe',litCricFriend('the',cantoXII))
...
# differently?
'''
The result shows that Poe and Neruda uses 'a', 'an' differently, and they also use 'the' differently.
'''
